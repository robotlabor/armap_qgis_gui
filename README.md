...
<br>The geotiff files should be locataed in the imagedata folder in the project folder. It has to be dowloaded from Google Drive because of the GitHUB size limitation.
